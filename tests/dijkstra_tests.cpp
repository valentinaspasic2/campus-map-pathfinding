...
void fillUicGraph() {
  ...
  ifstream input("data/uic-sp26.osm.json");
...
TEST(Dijkstra, Full) {
  ...
  vector<long long> expectedArcToSh = {
      ...
      8926492677, 12421562286, 8931833681, 12057116096, 13660098617, 
      1308089676, 10790261682, 10790261681, 1308089711, 13660098632, 
      12057116097, 7282826602, 11174876827, 464345395, 11174876819, 
      11257936376, 462010749, 9870872078, 462010764, 151676521 };    
  vector<long long> expectedSeoToSh = { 
      151960667, 1647971930, 462010746, 12108530536, 1645121274, 
      12923649673, 1645121428, 12108530537, 13593888507, 1645121533, 
      1647973070, 151676521 };
...
TEST(Dijkstra, FullSkipNodes) {
  ...
  vector<long long> expectedArcToLcb = {
      ...
      1308089676, 10790261682, 10790261681, 1308089711, 13660098632, 
      12057116097, 7282826602, 11174876827, 464345395, 11174876819, 
      11257936376, 462010749, 9870872078, 462010764, 462010765, 
      9870872105, 151672203};
  vector<long long> expectedErfToLcb = {
      151960677, 1647971980, 1647971942, 1647971957, 462014176, 
      9870872090, 462010748, 9862302460, 462010745, 10930768589, 
      465776558, 11257988864, 151672203};
